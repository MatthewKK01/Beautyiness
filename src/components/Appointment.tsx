...
function Appointment() {
  return (
    <section className="appointment px-[360px] py-[132px] bg-[#EDF5F7] flex flex-row items-center gap-28">
      <div>
        <h4 className="">Flat Discount</h4>
        <h1 className="text-left w-[438px]">
        ...
        <div className="flex">
          <div className="bg-white flex flex-col justify-center px-10 py-4">
